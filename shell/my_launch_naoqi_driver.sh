...
Set_NAO_IP_from_port () {
  if [ "$1" = "12345" ]
  then
    export NAO_IP=jarc.local
    source /home/mmoreaux/catkin_ws_ork/devel/setup.bash
  elif [ "$1" = "12346" ]
  then
    export NAO_IP=aipepper3.local
    source /home/mmoreaux/catkin_ws_ork/devel/setup.bash
  # elif [ "$1" = "12347" ]
  # then
  #   export NAO_IP=10.0.164.58
  #   source /home/mmoreaux/catkin_ws_ork/devel/setup.bash
  elif [ "$1" = "12347" ]
  then 
    export NAO_IP=pepperlaurent.local
    source /home/mmoreaux/work/catkin_ws_naoqi_driver/devel/setup.bash
  fi
}
